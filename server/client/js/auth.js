...
function updateAuthUI() {
    ...
    if (isAuthenticated && currentUser) {
        ...
        authSection.innerHTML = `
            <button class="nav-notification-btn" onclick="window.location.href='/dashboard/'" title="Notifications">
                🔔
                <span class="nav-notification-badge" id="notif-badge" style="display:none">0</span>
            </button>
            <a href="/dashboard/" class="btn btn-sm btn-secondary" style="gap: 8px;">
            ...
            ${isStaff ? '<a href="/admin-panel/" class="btn btn-sm btn-outline">Admin</a>' : ''}
